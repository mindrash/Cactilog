...
export const amazonProducts: AmazonProduct[] = [
  // Soil & Growing Medium
  {
    ...
    affiliateUrl: 'https://www.amazon.com/dp/B073F5PTQZ?tag=mindrash-20',
    category: 'soil',
  ...
  },
  {
    ...
    price: '$16.99',
    imageUrl: '/api/placeholder/150/150',
    affiliateUrl: 'https://www.amazon.com/dp/B01GJPOMHQ?tag=mindrash-20',
    category: 'soil',
  ...
  // Pots & Containers
  {
    ...
    price: '$24.99',
    imageUrl: '/api/placeholder/150/150',
    affiliateUrl: 'https://www.amazon.com/dp/B08XYRLX8G?tag=mindrash-20',
    category: 'pots',
  ...
  },
  {
    ...
    price: '$31.99',
    imageUrl: '/api/placeholder/150/150',
    affiliateUrl: 'https://www.amazon.com/dp/B084JBPQX7?tag=mindrash-20',
    category: 'pots',
  ...
  // Tools & Equipment
  {
    ...
    price: '$18.99',
    imageUrl: '/api/placeholder/150/150',
    affiliateUrl: 'https://www.amazon.com/dp/B07H8R5WP8?tag=mindrash-20',
    category: 'tools',
  ...
  },
  {
    ...
    price: '$14.95',
    imageUrl: '/api/placeholder/150/150',
    affiliateUrl: 'https://www.amazon.com/dp/B07QMRRZ4J?tag=mindrash-20',
    category: 'tools',
  ...
  // Fertilizer & Care
  {
    ...
    price: '$8.47',
    imageUrl: '/api/placeholder/150/150',
    affiliateUrl: 'https://www.amazon.com/dp/B000F4AVMA?tag=mindrash-20',
    category: 'fertilizer',
  ...
  // Books & Guides
  {
    ...
    price: '$19.95',
    imageUrl: '/api/placeholder/150/150',
    affiliateUrl: 'https://www.amazon.com/dp/B01M0PD8XP?tag=mindrash-20',
    category: 'books',
  ...
  // Grow Lights
  {
    ...
    price: '$29.99',
    imageUrl: '/api/placeholder/150/150',
    affiliateUrl: 'https://www.amazon.com/dp/B07QWV1KVT?tag=mindrash-20',
    category: 'lights',
  ...
  // Watering
  {
    ...
    price: '$22.99',
    imageUrl: '/api/placeholder/150/150',
    affiliateUrl: 'https://www.amazon.com/dp/B083QM4VWF?tag=mindrash-20',
    category: 'watering',
